odoo.define('1010_pos_dual_currency.CashMovePopupRefCurrency', function (require) {
    'use strict';
    ...
    class CashMovePopupRefCurrency extends AbstractAwaitablePopup {
        setup() {
            super.setup();
            this.state = useState({
                inputType: '', // '' | 'in' | 'out'
    ...
    CashMovePopupRefCurrency.template = 'CashMovePopupRefCurrency';
    CashMovePopupRefCurrency.defaultProps = {
        cancelText: _t('Cancel'),
        title: _t('Cash In/Out'),
    };

    Registries.Component.add(CashMovePopupRefCurrency);

    return CashMovePopupRefCurrency;
});
