...
export const PrintingMixin = (Parent) => class extends Parent {
    ...
    async setPort() {
        try {
            if (!this.port) {
                ...
                console.log("Verificando si el puerto esta abierto");
    ...
    async printZViaApi() {
        ...
        var url = this.env.pos.config.api_url + "/zreport/print";
    ...
    async printXViaApi() {
        ...
        var url = this.env.pos.config.api_url + "/xreport/print";
        $.get(url, function (data, status) {
    ...
    async printViaApi() {
        ...
        var url = this.env.pos.config.api_url + "/print_pos_ticket";
