...
class AccountAnalyticAccount(models.Model):
    ...
    balance_usd = fields.Monetary(currency_field='currency_id_dif',  string='Balance $',
                              groups='account.group_account_readonly')
    debit_usd = fields.Monetary(currency_field='currency_id_dif', string='Debito $',
                            groups='account.group_account_readonly')
    credit_usd = fields.Monetary(currency_field='currency_id_dif', string='Credito $',
                             groups='account.group_account_readonly')
...
#             aggregates=['amount:sum', 'amount_usd:sum'],
#         )
