...
# 
    ...
    same_currency = fields.Boolean(string="Mismo tipo de moneda")

    verificar_pagos = fields.Boolean(string="Verificar pagos")
...
#                     edit_trm = False
#             else:
#                 # if not self.env.user.has_group('account_dual_currency.group_dual_currency'):
#                 #     return res
#                 # if self.payment_id:
#                 #     self._compute_amount_residual_dual_currency_payment()
#                 #     return res
#                 # self._compute_amount_residual_dual_currency_invoice()
#                 # return res
...
#         res = super(AccountMove, self).js_assign_outstanding_line(line_id)
    # Metodos comentados para Zombie state
