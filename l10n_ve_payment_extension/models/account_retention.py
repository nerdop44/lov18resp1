...
#        }
    ...
    def compute_retention_lines_data(self, invoice_id, payment=None):
        ...
        tree[dict]
            The retention lines data.
        """
        # Verificación de la existencia de 'tax_totals' y 'subtotals'
        ...
        # Verificación de la existencia de 'groups_by_subtotal'
        
        if "groups_by_subtotal" not in invoice_id.tax_totals:
            raise UserError(_("Tax totals do not contain 'groups_by_subtotal' for this invoice."))
        ...
        subtotals_name = invoice_id.tax_totals["subtotals"][0]["name"]
            ...
            # Asegúrate de que subtotals_name esté en groups_by_subtotal
        if subtotals_name not in invoice_id.tax_totals["groups_by_subtotal"]:
            raise UserError(_("Subtotals name '%s' not found in tax totals." % subtotals_name))
